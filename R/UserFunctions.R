...
#' \describe{ \item{\code{\link{fast_generation}}}{Default method. Relatively
#' fast and memory efficient.} \item{\code{\link{bitset_generation}}}{Most
#' memory efficient method, slower than the others. Call with \code{method =
#' "bitset"}.} \item{\code{\link{pseudorandom_generation}}}{Fastest method, not
